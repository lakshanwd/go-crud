...
func main() {
	...
	router.Methods(http.MethodDelete).Path("/student").HandlerFunc(handler.StudentDeleteHandler)
	...
	router.Methods(http.MethodDelete).Path("/book").HandlerFunc(handler.BookDeleteHandler)
	...
	router.Methods(http.MethodDelete).Path("/studentbook").HandlerFunc(handler.StudentBookDeleteHandler)
